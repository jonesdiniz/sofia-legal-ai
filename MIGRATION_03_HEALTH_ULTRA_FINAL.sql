-- ═══════════════════════════════════════════════════════════════════════════
-- Migration: Health Monitoring & Alerts (VERSÃO ULTRA FINAL)
-- ═══════════════════════════════════════════════════════════════════════════
--
-- Sistema de monitoramento de saúde e alertas para Sofia
-- CORREÇÃO FINAL: Remove todas as dependências de tabelas que podem não existir
--
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- 3. FUNCTION: Obter Métricas de Saúde (SEM DEPENDÊNCIAS EXTERNAS)
-- ═══════════════════════════════════════════════════════════════════════════
...
BEGIN
  ...
  conversation_metrics AS (
    SELECT
      ...
      -- Conversas recentes (últimas 24h) como proxy para "ativas"
  ...
  SELECT
    ...
    END,
    cm.active_convs,
    0::BIGINT, -- pending_followups: retorna 0 (tabela follow_up_queue não existe)
